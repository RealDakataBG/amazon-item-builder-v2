      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="input-base font-mono text-xs leading-relaxed resize-y min-h-48 w-full"
            spellCheck={false}
          />
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <span className="label-muted">Output</span>
              {keywordsSuffix}
            </div>
          ...
          <textarea
            ...
            className="input-base text-sm leading-relaxed resize-y min-h-48 w-full"
            spellCheck={false}
          />
        </div>
      </div>
