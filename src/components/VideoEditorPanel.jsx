...
function RealVideoSection({ block, onChange }) {
  return (
    <div className="mb-6">
      <span className="label-muted block mb-2">Real Video</span>
      <textarea
...
function Rendering3dSection({ block, onChange }) {
  ...
  return (
    <div className="mb-6">
      <span className="label-muted block mb-2">3D Rendering</span>
      <textarea
        value={block.description}
        onChange={e => onChange('description', e.target.value)}
        className="input-base text-sm leading-relaxed resize-y min-h-20 mb-2"
...
export default function VideoEditorPanel({ slotLabel, data, onChange }) {
