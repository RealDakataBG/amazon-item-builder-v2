...
function Rendering3dSection({ block, onChange }) {
...
export default function VideoEditorPanel({ slotLabel, data, onChange, regenStatus, onRegenerate }) {
  ...
  return (
    <div className="relative flex gap-8 p-8">
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Real Video */}
        <RealVideoSection
          block={parsed.realVideo}
          onChange={(subfield, value) => onChange('realVideo', subfield, value)}
        />
      ...
      <div className="flex-1 min-w-0 sticky top-8 self-start space-y-6">
        ...
        />
        <UseAIBox
          label="Real Video — Description"
          targetValue={parsed.realVideo?.description ?? ''}
          onAccept={val => onChange('realVideo', 'description', val)}
        />
        <UseAIBox
