    ...
    <div className="h-full flex flex-col p-8 max-w-4xl">
      ...
      {parseError && (
        <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
          <p className="text-sm font-medium text-amber-700">Parse warning: {parseError}</p>
          <p className="text-xs text-amber-600 mt-1 font-mono whitespace-pre-wrap break-all">{rawOutput}</p>
        </div>
      )}
